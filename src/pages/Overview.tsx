...
export default function Overview() {
  ...
  return (
    <div>
      <h1 className="pb-1 text-3xl font-bold tracking-tight text-slate-50">Overview</h1>
      ...
      <h2 className="mt-10 mb-3 text-lg font-semibold text-slate-100">Recent activity</h2>
